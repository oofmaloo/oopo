...
contract LendingPoolAddressesProvider is ILendingPoolAddressesProvider {
   ...
   */
  function setMarketId(string memory marketId) external override {
    _setMarketId(marketId);
  }
   ...
   **/
  function setLendingPool(address pool) external override {
   ...
   **/
  function setLendingPoolConfigurator(address configurator) external override {
  ...
  function setEmergencyAdmin(address emergencyAdmin) external override {
