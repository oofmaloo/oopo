...
/**
 * @title MockReserveLogic library
 * @author Aave
 * @notice Implements the logic to update the reserves state
 */
library MockReserveLogic {
  ...
  function init(
    ...
    reserve.currentLiquidityRate = uint128(100000000000000000000000000);
  ...
  function updateInterestRates(
    ...
    reserve.currentStableBorrowRate = 0;
